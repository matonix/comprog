...
main = do
  (a,b,m) <- readInteger3 <$> BS.getLine
  print $ solve a b m

solve :: Integer -> Integer -> Integer -> Integer
solve a b m = lcm a' b' `mod` m where
  a' = read $ genericReplicate a '1'
  b' = read $ genericReplicate b '1'
...
readInteger3 = toTriple . map readInteger . BS.words
